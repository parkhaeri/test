...
var c = document.querySelector("#scrapeIt .container")
var cc = c.getBoundingClientRect()
var s = document.querySelector("#scraper")
var ex = document.querySelector(".explain")


function scraper(e){
  x = e.clientX - ((window.innerWidth - 1900)/2) - 25
  y = e.clientY - cc.top - 25 
  s.style.left = x+"px"
  s.style.top = y+"px"
}
c.addEventListener('mousemove', scraper)
